...
const pages = ["index.html", "vertex-curl.html", "energy-playground.html", "dec-playground.html", "getting-started.html", "shallow-water.html", "representations.html", "references.html"];
const assets = ["wasm/gp_lab_kernels.js", "wasm/gp_lab_kernels.wasm", "og.png"];
const failures = [];
